...
# simple-book-with-payment >> with-payment-property (FacilityUseSlot)
...
⚠️ 5 passed with 0 failures, 72 warnings and 2 suggestions 
...
Response status code: 200 OK. Responded in 16.149736ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10049"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/4ed95fa5-e370-5ba4-b89f-b66f2c3ad305

---

Response status code: 204 No Content. Responded in 68.719626ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1049%2Ffacility-use-slots%2F10049?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 564.286239ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10049",
  "modified": 1602103020063,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10049",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10049#/offers/0",
        "availableChannel": [
    ...
    "remainingUses": 10,
    "startDate": "2020-10-08T20:36:58+00:00",
    "endDate": "2020-10-08T21:36:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4ed95fa5-e370-5ba4-b89f-b66f2c3ad305
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 280.383279ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4ed95fa5-e370-5ba4-b89f-b66f2c3ad305",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4ed95fa5-e370-5ba4-b89f-b66f2c3ad305
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 256.305875ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:41:59+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4ed95fa5-e370-5ba4-b89f-b66f2c3ad305
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 1131.333882ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4ed95fa5-e370-5ba4-b89f-b66f2c3ad305",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4ed95fa5-e370-5ba4-b89f-b66f2c3ad305#/orderedItems/374",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1049/facility-use-slots/10049#/offers/0",
        "price": 14.99,
