...
# minimal-proposal >> not-accept-proposal-book (ScheduledSession)
...
Response status code: 200 OK. Responded in 230.925645ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1030/events/10030"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1030%2Fevents%2F10030?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 752.009995ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1030/events/10030",
  "modified": 1602103004411,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1030/events/10030",
    ...
    "startDate": "2020-10-08T20:36:42+00:00",
    "endDate": "2020-10-08T21:36:42+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4593222b-9606-5ac7-8654-e2134e2e575a
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 245.780686ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4593222b-9606-5ac7-8654-e2134e2e575a",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4593222b-9606-5ac7-8654-e2134e2e575a
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 425.717348ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:41:44+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### get-order Request
GET http://localhost:3000/get-order/4593222b-9606-5ac7-8654-e2134e2e575a
**Response still pending**

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4593222b-9606-5ac7-8654-e2134e2e575a
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 200 OK. Responded in 431.577328ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/4593222b-9606-5ac7-8654-e2134e2e575a",
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/4593222b-9606-5ac7-8654-e2134e2e575a/versions/9dd14ac4-7a93-4d44-9cda-6d67a9b12be6",
  "payment": {
    "@type": "Payment",
    "identifier": "1234567890npduy2f",
    "name": "AcmeBroker Points",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4593222b-9606-5ac7-8654-e2134e2e575a
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 500 Internal Server Error. Responded in 10.217258ms
```json
{
  "@context": "https://openactive.io/",
...
get-order - GET http://localhost:3000/get-order/4593222b-9606-5ac7-8654-e2134e2e575a
