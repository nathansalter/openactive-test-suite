[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:36:54 GMT+0000 (Coordinated Universal Time)
...
⚠️ 15 passed with 0 failures, 378 warnings and 84 suggestions 
...
Response status code: 200 OK. Responded in 83.285768ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1054/events/10054"
}
```
...
Response status code: 200 OK. Responded in 229.671384ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10056"
}
```
...
Response status code: 200 OK. Responded in 233.527168ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10057"
}
```
...
Response status code: 200 OK. Responded in 81.574875ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10054"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4

---

Response status code: 204 No Content. Responded in 47.206113ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1054%2Fevents%2F10054?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 329.857985ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1054/events/10054",
  "modified": 1602103023017,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1054/events/10054",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1054",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1054#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-10-08T20:37:01+00:00",
    "endDate": "2020-10-08T21:37:01+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1056%2Fevents%2F10056?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 328.847088ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10056",
  "modified": 1602103023018,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1056/events/10056",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1057%2Ffacility-use-slots%2F10057?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 786.758166ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10057",
  "modified": 1602103023484,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10057",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10057#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 14.99,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1054%2Ffacility-use-slots%2F10054?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 302.322694ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10054",
  "modified": 1602103023001,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10054",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10054#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 669.14644ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 913.750578ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:42:05+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 576.59102ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4#/orderedItems/396",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1054#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4#/orderedItems/397",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1054#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4#/orderedItems/398",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1056#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4#/orderedItems/399",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10057#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4#/orderedItems/400",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10057#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d2629ccd-0b48-5f81-bfdd-71cb4205dcd4#/orderedItems/401",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10054#/offers/0",
        "price": 14.99,
