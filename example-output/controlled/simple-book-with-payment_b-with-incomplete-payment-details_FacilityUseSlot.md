...
Response status code: 200 OK. Responded in 21.311016ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1062/facility-use-slots/10062"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/8c506ebc-aba9-5b60-ac49-3e22d0e6a6a6

---

Response status code: 404 Not Found. Responded in 11.410155ms
```json
{
  "@context": "https://openactive.io/",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1062%2Ffacility-use-slots%2F10062?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 790.074092ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1062/facility-use-slots/10062",
  "modified": 1602103031531,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1062/facility-use-slots/10062",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1062/facility-use-slots/10062#/offers/0",
        "availableChannel": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8c506ebc-aba9-5b60-ac49-3e22d0e6a6a6
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 228.224203ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8c506ebc-aba9-5b60-ac49-3e22d0e6a6a6",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8c506ebc-aba9-5b60-ac49-3e22d0e6a6a6
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 257.909987ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:42:11+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8c506ebc-aba9-5b60-ac49-3e22d0e6a6a6
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 188.232061ms
```json
{
  "@context": "https://openactive.io/",
