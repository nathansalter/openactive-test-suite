[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:37:09 GMT+0000 (Coordinated Universal Time)

# simple-book-free-opportunities >> with-erroneous-payment-property (FacilityUseSlot)
...
Response status code: 200 OK. Responded in 21.737415ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1063/facility-use-slots/10063"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1063%2Ffacility-use-slots%2F10063?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 781.758431ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1063/facility-use-slots/10063",
  "modified": 1602103033032,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1063/facility-use-slots/10063",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1063",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1063/facility-use-slots/10063#/offers/0",
        "availableChannel": [
    ...
    "remainingUses": 10,
    "startDate": "2020-10-08T20:37:11+00:00",
    "endDate": "2020-10-08T21:37:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fd8ddd2e-1017-5913-ae49-b77269dfd14c
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 223.718923ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fd8ddd2e-1017-5913-ae49-b77269dfd14c",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fd8ddd2e-1017-5913-ae49-b77269dfd14c
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 333.964891ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fd8ddd2e-1017-5913-ae49-b77269dfd14c
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 862.162625ms
```json
{
  "@context": "https://openactive.io/",
