[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:37:07 GMT+0000 (Coordinated Universal Time)

# simple-book-with-payment >> b-with-incomplete-payment-details (ScheduledSession)
...
⚠️ 6 passed with 0 failures, 56 warnings and 20 suggestions 
...
Response status code: 200 OK. Responded in 101.733698ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1060/events/10060"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/94f82f0f-8eb4-540a-893c-acea2b173552

---

Response status code: 404 Not Found. Responded in 13.630447ms
```json
{
  "@context": "https://openactive.io/",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1060%2Fevents%2F10060?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 429.176005ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1060/events/10060",
  "modified": 1602103028995,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1060/events/10060",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1060",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1060#/offers/0",
          "availableChannel": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/94f82f0f-8eb4-540a-893c-acea2b173552
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 376.477416ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/94f82f0f-8eb4-540a-893c-acea2b173552",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/94f82f0f-8eb4-540a-893c-acea2b173552
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 302.895707ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/94f82f0f-8eb4-540a-893c-acea2b173552
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 206.469587ms
```json
{
  "@context": "https://openactive.io/",
