[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:37:18 GMT+0000 (Coordinated Universal Time)

# availability-check >> opportunity-full (FacilityUseSlot)
...
⚠️ 6 passed with 0 failures, 58 warnings and 2 suggestions 
...
Response status code: 200 OK. Responded in 19.145926ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1074/facility-use-slots/10074"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1074%2Ffacility-use-slots%2F10074?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 491.999393ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1074/facility-use-slots/10074",
  "modified": 1602103042320,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1074/facility-use-slots/10074",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1074",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1074/facility-use-slots/10074#/offers/0",
        "availableChannel": [
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6383331b-ef30-5e78-b7b4-fbf4e59bea82
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 409 Conflict. Responded in 271.515648ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6383331b-ef30-5e78-b7b4-fbf4e59bea82",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6383331b-ef30-5e78-b7b4-fbf4e59bea82
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 409 Conflict. Responded in 389.627292ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
 ...
 * ⚠️ $.orderedItem[0].error[0].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[0].error[0].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[0].error[1].description: Recommended property `description` is missing from `OpportunityHasInsufficientCapacityError`.
 * ⚠️ $.orderedItem[0].error[1].instance: Recommended property `instance` is missing from `OpportunityHasInsufficientCapacityError`.
 * ⚠️ $.orderedItem[0].orderedItem.duration: Recommended property `duration` is missing from `Slot`.
 * ⚠️ $.orderedItem[0].orderedItem.facilityUse.description: Recommended property `description` is missing from `FacilityUse`.
 * ⚠️ $.orderedItem[0].orderedItem.facilityUse.image: Recommended property `image` is missing from `FacilityUse`.
 * ⚠️ $.orderedItem[0].orderedItem.facilityUse.hoursAvailable: Recommended property `hoursAvailable` is missing from `FacilityUse`.
