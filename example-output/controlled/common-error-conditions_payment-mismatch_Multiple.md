...
⚠️ 15 passed with 0 failures, 283 warnings and 66 suggestions 
...
Response status code: 200 OK. Responded in 257.188066ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1049/events/10049"
}
```
...
Response status code: 200 OK. Responded in 111.080853ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1048/events/10048"
}
```
...
Response status code: 200 OK. Responded in 104.082482ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10046"
}
```
...
Response status code: 200 OK. Responded in 401.590587ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1048/facility-use-slots/10048"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1049%2Fevents%2F10049?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 306.329071ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1049/events/10049",
  "modified": 1602103018579,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1049/events/10049",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1048%2Fevents%2F10048?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 15.726137ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1046%2Ffacility-use-slots%2F10046?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 275.368895ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10046",
  "modified": 1602103018548,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10046",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10046#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 14.99,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1048%2Ffacility-use-slots%2F10048?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 620.26421ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1048/facility-use-slots/10048",
  "modified": 1602103018893,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1048/facility-use-slots/10048",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1048/facility-use-slots/10048#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6435ec1b-19ee-588b-8969-96084a5145af
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 412.751146ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6435ec1b-19ee-588b-8969-96084a5145af",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6435ec1b-19ee-588b-8969-96084a5145af
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 623.133909ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:42:00+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6435ec1b-19ee-588b-8969-96084a5145af
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 664.12365ms
```json
{
  "@context": "https://openactive.io/",
