...
⚠️ 23 passed with 0 failures, 412 warnings and 84 suggestions 
...
Response status code: 200 OK. Responded in 375.816803ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1015/events/10015"
}
```
...
Response status code: 200 OK. Responded in 391.312637ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1016/events/10016"
}
```
...
Response status code: 200 OK. Responded in 392.604232ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1016/facility-use-slots/10016"
}
```
...
Response status code: 200 OK. Responded in 390.56774ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1015/facility-use-slots/10015"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1015%2Fevents%2F10015?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 455.314969ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1015/events/10015",
  "modified": 1602102992536,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1015/events/10015",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1016%2Fevents%2F10016?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 455.120671ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1016/events/10016",
  "modified": 1602102992537,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1016/events/10016",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1016%2Ffacility-use-slots%2F10016?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 673.470745ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1016/facility-use-slots/10016",
  "modified": 1602102992757,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1016/facility-use-slots/10016",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1016",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1016/facility-use-slots/10016#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "openBookingFlowRequirement": [
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1015%2Ffacility-use-slots%2F10015?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 672.460548ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1015/facility-use-slots/10015",
  ...
  "data": {
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1015/facility-use-slots/10015#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d56f419a-d626-5768-a7a9-d4d4495e3050
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 677.970333ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d56f419a-d626-5768-a7a9-d4d4495e3050",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d56f419a-d626-5768-a7a9-d4d4495e3050
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 510.970047ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### get-order Request
GET http://localhost:3000/get-order/d56f419a-d626-5768-a7a9-d4d4495e3050

---

Response status code: 200 OK. Responded in 3919.693188ms
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "d56f419a-d626-5768-a7a9-d4d4495e3050",
  "modified": 637376997964102500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/d56f419a-d626-5768-a7a9-d4d4495e3050",
    "identifier": "d56f419a-d626-5768-a7a9-d4d4495e3050",
    ...
    "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/d56f419a-d626-5768-a7a9-d4d4495e3050/versions/4a4e4d61-d555-434c-bc18-6daa29c50b85",
    "totalPaymentDue": {
      "@type": "PriceSpecification",
      "price": 89.94,
      "priceCurrency": "GBP"
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d56f419a-d626-5768-a7a9-d4d4495e3050
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 200 OK. Responded in 924.254016ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 204 No Content. Responded in 53.500075ms
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d56f419a-d626-5768-a7a9-d4d4495e3050
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 500 Internal Server Error. Responded in 25.504193ms
```json
{
  "@context": "https://openactive.io/",
