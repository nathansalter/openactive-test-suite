[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:36:42 GMT+0000 (Coordinated Universal Time)

# minimal-proposal >> not-accept-proposal-book (Multiple)
...
⚠️ 19 passed with 0 failures, 379 warnings and 84 suggestions 
...
Response status code: 200 OK. Responded in 52.204287ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1037/events/10037"
}
```
...
Response status code: 200 OK. Responded in 63.260442ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1038/events/10038"
}
```
...
Response status code: 200 OK. Responded in 63.461841ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1036/facility-use-slots/10036"
}
```
...
Response status code: 200 OK. Responded in 62.514845ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10035"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1037%2Fevents%2F10037?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 362.141022ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1037/events/10037",
  "modified": 1602103009549,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1037/events/10037",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1037",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event With Approval",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1037#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-10-08T20:36:48+00:00",
    "endDate": "2020-10-08T21:36:48+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1038%2Fevents%2F10038?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 362.018822ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/1038/events/10038",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1036%2Ffacility-use-slots%2F10036?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 347.249682ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1036/facility-use-slots/10036",
  "modified": 1602103009536,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1036/facility-use-slots/10036",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1036",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1036/facility-use-slots/10036#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "openBookingFlowRequirement": [
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1035%2Ffacility-use-slots%2F10035?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 346.032188ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10035",
  "modified": 1602103009535,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Slot",
    "@id": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10035",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10035#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 14.99,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e770a725-a9dd-528c-8525-bc3531bf9176
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 302.909566ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e770a725-a9dd-528c-8525-bc3531bf9176",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e770a725-a9dd-528c-8525-bc3531bf9176
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 967.44147ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### get-order Request
GET http://localhost:3000/get-order/e770a725-a9dd-528c-8525-bc3531bf9176
**Response still pending**

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/e770a725-a9dd-528c-8525-bc3531bf9176
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 200 OK. Responded in 328.448069ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/e770a725-a9dd-528c-8525-bc3531bf9176",
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/e770a725-a9dd-528c-8525-bc3531bf9176/versions/065825af-6081-442f-b480-6aa31700d0dc",
  "payment": {
    "@type": "Payment",
    "identifier": "1234567890npduy2f",
    "name": "AcmeBroker Points",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e770a725-a9dd-528c-8525-bc3531bf9176
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 500 Internal Server Error. Responded in 22.036711ms
```json
{
  "@context": "https://openactive.io/",
...
get-order - GET http://localhost:3000/get-order/e770a725-a9dd-528c-8525-bc3531bf9176
