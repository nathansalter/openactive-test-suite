...
# amending-order-quote >> c2-with-different-details (FacilityUseSlot)
...
Response status code: 200 OK. Responded in 4.37977ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/55/facility-use-slots/546"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F55%2Ffacility-use-slots%2F546?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 3.398777ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/55",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/55/facility-use-slots/546#/offers/0",
        "availableChannel": [
    ...
    "remainingUses": 6,
    "startDate": "2020-10-12T01:58:32+00:00",
    "endDate": "2020-10-12T05:20:32+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f3a2b662-93ef-560c-b292-41ce3859c9fe
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 354.132751ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f3a2b662-93ef-560c-b292-41ce3859c9fe",
...
Response status code: 200 OK. Responded in 4.109072ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/294/facility-use-slots/2934"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F294%2Ffacility-use-slots%2F2934?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 7.793946ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/294",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/294/facility-use-slots/2934#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 7,
    "startDate": "2020-10-15T06:19:21+00:00",
    "endDate": "2020-10-15T09:49:21+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f3a2b662-93ef-560c-b292-41ce3859c9fe
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 510.566585ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f3a2b662-93ef-560c-b292-41ce3859c9fe
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 434.978814ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f3a2b662-93ef-560c-b292-41ce3859c9fe",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f3a2b662-93ef-560c-b292-41ce3859c9fe#/orderedItems/12",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/294/facility-use-slots/2934#/offers/0",
        "price": 0,
