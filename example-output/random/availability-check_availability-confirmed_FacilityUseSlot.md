[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:35:29 GMT+0000 (Coordinated Universal Time)

# availability-check >> availability-confirmed (FacilityUseSlot)
...
⚠️ 6 passed with 0 failures, 52 warnings and 2 suggestions 
...
Response status code: 200 OK. Responded in 10.424545ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/710/facility-use-slots/7093"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F710%2Ffacility-use-slots%2F7093?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 2.908685ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/710",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/710/facility-use-slots/7093#/offers/0",
        "availableChannel": [
    ...
    "remainingUses": 5,
    "startDate": "2020-10-12T22:49:03+00:00",
    "endDate": "2020-10-13T01:20:03+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a1c47ff0-5875-591c-b7fb-5acbab9f43cc
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 628.383672ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a1c47ff0-5875-591c-b7fb-5acbab9f43cc",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/710"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2020-10-12T22:49:03+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a1c47ff0-5875-591c-b7fb-5acbab9f43cc
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 355.836725ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:32+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
