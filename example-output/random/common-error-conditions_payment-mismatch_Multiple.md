[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:35:28 GMT+0000 (Coordinated Universal Time)
...
⚠️ 15 passed with 0 failures, 285 warnings and 66 suggestions 
...
Response status code: 200 OK. Responded in 28.076053ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/254/events/2539"
}
```
...
Response status code: 200 OK. Responded in 27.644855ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/293/events/2929"
}
```
...
Response status code: 200 OK. Responded in 27.070458ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/393/facility-use-slots/3928"
}
```
...
Response status code: 200 OK. Responded in 24.80577ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/427/facility-use-slots/4264"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F254%2Fevents%2F2539?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 67.220247ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-08T12:53:45+00:00",
    "endDate": "2020-10-08T18:28:45+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F293%2Fevents%2F2929?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 67.207348ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/293",
      "name": "Concrete Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/293#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-10-12T08:54:44+00:00",
    "endDate": "2020-10-12T11:05:44+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F393%2Ffacility-use-slots%2F3928?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 67.040248ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/393",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/393/facility-use-slots/3928#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 18.37,
    ...
    "remainingUses": 5,
    "startDate": "2020-10-17T06:14:24+00:00",
    "endDate": "2020-10-17T09:02:24+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F427%2Ffacility-use-slots%2F4264?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 66.446151ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/427/facility-use-slots/4264#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 6.19,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-15T19:26:42+00:00",
    "endDate": "2020-10-16T01:09:42+00:00"
  }
}
```
### Specs
...
## Total Payment Due mismatch at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookablePaid' required for this test
...
## Total Payment Due mismatch at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookablePaid' required for this test
...
## Total Payment Due mismatch at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dd5b8ccb-c742-5e81-9b3f-36b631c7f891
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 599.727772ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dd5b8ccb-c742-5e81-9b3f-36b631c7f891",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dd5b8ccb-c742-5e81-9b3f-36b631c7f891
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 1026.787484ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:36+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/dd5b8ccb-c742-5e81-9b3f-36b631c7f891
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 702.743389ms
```json
{
  "@context": "https://openactive.io/",
