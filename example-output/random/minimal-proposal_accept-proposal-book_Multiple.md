...
# minimal-proposal >> accept-proposal-book (Multiple)
...
⚠️ 23 passed with 0 failures, 510 warnings and 102 suggestions 
...
Response status code: 200 OK. Responded in 14.150415ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/570/events/5693"
}
```
...
Response status code: 200 OK. Responded in 13.14612ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/760/events/7600"
}
```
...
Response status code: 200 OK. Responded in 12.189726ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/217/facility-use-slots/2164"
}
```
...
Response status code: 200 OK. Responded in 11.211432ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/920/facility-use-slots/9194"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F570%2Fevents%2F5693?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 31.971107ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/570",
      "name": "Steel Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/570#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-10-09T06:55:20+00:00",
    "endDate": "2020-10-09T10:50:20+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F760%2Fevents%2F7600?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 42.339744ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-13T14:37:26+00:00",
    "endDate": "2020-10-13T20:23:26+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F217%2Ffacility-use-slots%2F2164?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 43.030139ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/217",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/217/facility-use-slots/2164#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "openBookingFlowRequirement": [
    ...
    "remainingUses": 8,
    "startDate": "2020-10-08T15:02:22+00:00",
    "endDate": "2020-10-08T20:43:22+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F920%2Ffacility-use-slots%2F9194?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 44.000534ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/920",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/920/facility-use-slots/9194#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 5,
    "startDate": "2020-10-10T00:46:01+00:00",
    "endDate": "2020-10-10T01:46:01+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/015138da-d922-5e4b-8278-1f2fc8c0b579
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 614.282213ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/015138da-d922-5e4b-8278-1f2fc8c0b579",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/570"
        },
        "maximumAttendeeCapacity": 30,
        "remainingAttendeeCapacity": 30,
        "startDate": "2020-10-09T06:55:20+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/920"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2020-10-10T00:46:01+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/015138da-d922-5e4b-8278-1f2fc8c0b579
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 526.572265ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:11+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### get-order Request
GET http://localhost:3000/get-order/015138da-d922-5e4b-8278-1f2fc8c0b579

---

Response status code: 200 OK. Responded in 3940.347167ms
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "015138da-d922-5e4b-8278-1f2fc8c0b579",
  "modified": 637376997136697000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/015138da-d922-5e4b-8278-1f2fc8c0b579",
    "identifier": "015138da-d922-5e4b-8278-1f2fc8c0b579",
    ...
    "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/015138da-d922-5e4b-8278-1f2fc8c0b579/versions/a228e537-0ecf-49f6-8f3d-9ff0fb5e3d17",
    "totalPaymentDue": {
      "@type": "PriceSpecification",
      "price": 45.62,
      "priceCurrency": "GBP"
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/015138da-d922-5e4b-8278-1f2fc8c0b579
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 200 OK. Responded in 792.852123ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 204 No Content. Responded in 179.10885ms
### Specs
 ...
 * ⚠️ $.orderedItem[0].acceptedOffer.name: Recommended property `name` is missing from `Offer`.
 * ⚠️ $.orderedItem[0].acceptedOffer.ageRange: Recommended property `ageRange` is missing from `Offer`.
 * ⚠️ $.orderedItem[1].allowCustomerCancellationFullRefund: Recommended property `allowCustomerCancellationFullRefund` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[1].accessCode: Recommended property `accessCode` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[1].accessPass: Recommended property `accessPass` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[1].acceptedOffer.name: Recommended property `name` is missing from `Offer`.
 * ⚠️ $.orderedItem[1].acceptedOffer.ageRange: Recommended property `ageRange` is missing from `Offer`.
 * ⚠️ $.orderedItem[2].allowCustomerCancellationFullRefund: Recommended property `allowCustomerCancellationFullRefund` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[2].accessCode: Recommended property `accessCode` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[2].accessPass: Recommended property `accessPass` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[2].acceptedOffer.name: Recommended property `name` is missing from `Offer`.
 * ⚠️ $.orderedItem[2].acceptedOffer.ageRange: Recommended property `ageRange` is missing from `Offer`.
 * ⚠️ $.orderedItem[3].allowCustomerCancellationFullRefund: Recommended property `allowCustomerCancellationFullRefund` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[3].accessCode: Recommended property `accessCode` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[3].accessPass: Recommended property `accessPass` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[3].acceptedOffer.name: Recommended property `name` is missing from `Offer`.
 * ⚠️ $.orderedItem[3].acceptedOffer.ageRange: Recommended property `ageRange` is missing from `Offer`.
 * ⚠️ $.orderedItem[3].orderedItem.maximumUses: Recommended property `maximumUses` is missing from `Slot`.
 * ⚠️ $.orderedItem[4].allowCustomerCancellationFullRefund: Recommended property `allowCustomerCancellationFullRefund` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[4].accessCode: Recommended property `accessCode` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[4].accessPass: Recommended property `accessPass` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[4].acceptedOffer.name: Recommended property `name` is missing from `Offer`.
 * ⚠️ $.orderedItem[4].acceptedOffer.ageRange: Recommended property `ageRange` is missing from `Offer`.
 * ⚠️ $.orderedItem[4].orderedItem.maximumUses: Recommended property `maximumUses` is missing from `Slot`.
 * ⚠️ $.orderedItem[5].allowCustomerCancellationFullRefund: Recommended property `allowCustomerCancellationFullRefund` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[5].accessCode: Recommended property `accessCode` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[5].accessPass: Recommended property `accessPass` is missing from `OrderItem`.
 * ⚠️ $.orderedItem[5].acceptedOffer.name: Recommended property `name` is missing from `Offer`.
 * ⚠️ $.orderedItem[5].acceptedOffer.ageRange: Recommended property `ageRange` is missing from `Offer`.
 * ⚠️ $.orderedItem[5].orderedItem.maximumUses: Recommended property `maximumUses` is missing from `Slot`.

## B

### B Request
PUT https://localhost:5001/api/openbooking/orders/015138da-d922-5e4b-8278-1f2fc8c0b579
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 770.384765ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/015138da-d922-5e4b-8278-1f2fc8c0b579",
  "identifier": "015138da-d922-5e4b-8278-1f2fc8c0b579",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/015138da-d922-5e4b-8278-1f2fc8c0b579#/orderedItems/110",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/570#/offers/0",
        "price": 5.75,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/015138da-d922-5e4b-8278-1f2fc8c0b579#/orderedItems/111",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/570#/offers/0",
        "price": 5.75,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/015138da-d922-5e4b-8278-1f2fc8c0b579#/orderedItems/112",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/760#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/015138da-d922-5e4b-8278-1f2fc8c0b579#/orderedItems/113",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/217/facility-use-slots/2164#/offers/0",
        "price": 17.06,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/015138da-d922-5e4b-8278-1f2fc8c0b579#/orderedItems/114",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/217/facility-use-slots/2164#/offers/0",
        "price": 17.06,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/015138da-d922-5e4b-8278-1f2fc8c0b579#/orderedItems/115",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/920/facility-use-slots/9194#/offers/0",
        "price": 0,
