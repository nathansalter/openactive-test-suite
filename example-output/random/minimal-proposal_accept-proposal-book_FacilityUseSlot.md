...
# minimal-proposal >> accept-proposal-book (FacilityUseSlot)
...
⚠️ 13 passed with 0 failures, 98 warnings and 2 suggestions 
...
Response status code: 200 OK. Responded in 19.903876ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/653/facility-use-slots/6530"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F653%2Ffacility-use-slots%2F6530?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.598747ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/653/facility-use-slots/6530#/offers/0",
        "availableChannel": [
    ...
    "remainingUses": 5,
    "startDate": "2020-10-11T09:00:40+00:00",
    "endDate": "2020-10-11T09:47:40+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b16f3e5f-57d7-53c8-8786-b05fa770c3b0
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 269.260128ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b16f3e5f-57d7-53c8-8786-b05fa770c3b0",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b16f3e5f-57d7-53c8-8786-b05fa770c3b0
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 233.36545ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:04+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### get-order Request
GET http://localhost:3000/get-order/b16f3e5f-57d7-53c8-8786-b05fa770c3b0

---

Response status code: 200 OK. Responded in 3131.812028ms
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b16f3e5f-57d7-53c8-8786-b05fa770c3b0",
  "modified": 637376997058343600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b16f3e5f-57d7-53c8-8786-b05fa770c3b0",
    "identifier": "b16f3e5f-57d7-53c8-8786-b05fa770c3b0",
    ...
    "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b16f3e5f-57d7-53c8-8786-b05fa770c3b0/versions/b1ccba21-c5dd-46ad-845c-7e0dd5b5096a",
    "totalPaymentDue": {
      "@type": "PriceSpecification",
      "price": 2.84,
      "priceCurrency": "GBP"
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b16f3e5f-57d7-53c8-8786-b05fa770c3b0
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 200 OK. Responded in 476.314261ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 204 No Content. Responded in 37.365869ms
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b16f3e5f-57d7-53c8-8786-b05fa770c3b0
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 304.639957ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b16f3e5f-57d7-53c8-8786-b05fa770c3b0",
  "identifier": "b16f3e5f-57d7-53c8-8786-b05fa770c3b0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b16f3e5f-57d7-53c8-8786-b05fa770c3b0#/orderedItems/76",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/653/facility-use-slots/6530#/offers/0",
        "price": 2.84,
