...
⚠️ 46 passed with 0 failures, 576 warnings and 132 suggestions 
...
Response status code: 200 OK. Responded in 14.127903ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/961/events/9601"
}
```
...
Response status code: 200 OK. Responded in 23.271742ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/535/events/5343"
}
```
...
Response status code: 200 OK. Responded in 22.648346ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/866/facility-use-slots/8653"
}
```
...
Response status code: 200 OK. Responded in 22.167649ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/989/facility-use-slots/9888"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F961%2Fevents%2F9601?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 6.641855ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/961",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/961#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-10-10T09:46:12+00:00",
    "endDate": "2020-10-10T12:40:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F535%2Fevents%2F5343?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 7.109152ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-14T02:09:39+00:00",
    "endDate": "2020-10-14T04:37:39+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F866%2Ffacility-use-slots%2F8653?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 9.898633ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/866",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/866/facility-use-slots/8653#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0.05,
    ...
    "remainingUses": 7,
    "startDate": "2020-10-10T11:44:41+00:00",
    "endDate": "2020-10-10T15:17:41+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F989%2Ffacility-use-slots%2F9888?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 9.483635ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/989",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/989/facility-use-slots/9888#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-14T03:34:48+00:00",
    "endDate": "2020-10-14T06:41:48+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5a508de3-67ed-5cb0-b30a-efea3e0b6d20
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 579.421865ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5a508de3-67ed-5cb0-b30a-efea3e0b6d20",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/961"
        },
        "maximumAttendeeCapacity": 38,
        "remainingAttendeeCapacity": 38,
        "startDate": "2020-10-10T09:46:12+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/866"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2020-10-10T11:44:41+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/989"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2020-10-14T03:34:48+00:00",
...
Response status code: 200 OK. Responded in 50.21026ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/934/events/9337"
}
```
...
Response status code: 200 OK. Responded in 49.533665ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/800/events/7998"
}
```
...
Response status code: 200 OK. Responded in 49.143068ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/193/facility-use-slots/1924"
}
```
...
Response status code: 200 OK. Responded in 48.76247ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/918/facility-use-slots/9173"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F934%2Fevents%2F9337?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 16.069291ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/934",
      "name": "Cotton Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/934#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 10.99,
    ...
    "maximumAttendeeCapacity": 3,
    "remainingAttendeeCapacity": 3,
    "startDate": "2020-10-14T05:25:25+00:00",
    "endDate": "2020-10-14T09:30:25+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F800%2Fevents%2F7998?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 15.675294ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/800",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/800#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-10-16T02:46:31+00:00",
    "endDate": "2020-10-16T08:13:31+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F193%2Ffacility-use-slots%2F1924?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.361844ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/193",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/193/facility-use-slots/1924#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 2.89,
    ...
    "remainingUses": 4,
    "startDate": "2020-10-16T11:52:19+00:00",
    "endDate": "2020-10-16T15:36:19+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F918%2Ffacility-use-slots%2F9173?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.203344ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/918",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/918/facility-use-slots/9173#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 8,
    "startDate": "2020-10-10T09:54:57+00:00",
    "endDate": "2020-10-10T15:40:57+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 682.313234ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/934"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3,
        "startDate": "2020-10-14T05:25:25+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/800"
        },
        "maximumAttendeeCapacity": 34,
        "remainingAttendeeCapacity": 34,
        "startDate": "2020-10-16T02:46:31+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/193"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2020-10-16T11:52:19+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/918"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2020-10-10T09:54:57+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5a508de3-67ed-5cb0-b30a-efea3e0b6d20
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 527.432411ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:39:55+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5a508de3-67ed-5cb0-b30a-efea3e0b6d20
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 968.814734ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5a508de3-67ed-5cb0-b30a-efea3e0b6d20",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a508de3-67ed-5cb0-b30a-efea3e0b6d20#/orderedItems/47",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/934#/offers/0",
        "price": 10.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a508de3-67ed-5cb0-b30a-efea3e0b6d20#/orderedItems/48",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/934#/offers/0",
        "price": 10.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a508de3-67ed-5cb0-b30a-efea3e0b6d20#/orderedItems/49",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/800#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a508de3-67ed-5cb0-b30a-efea3e0b6d20#/orderedItems/50",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/193/facility-use-slots/1924#/offers/0",
        "price": 2.89,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a508de3-67ed-5cb0-b30a-efea3e0b6d20#/orderedItems/51",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/193/facility-use-slots/1924#/offers/0",
        "price": 2.89,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a508de3-67ed-5cb0-b30a-efea3e0b6d20#/orderedItems/52",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/918/facility-use-slots/9173#/offers/0",
        "price": 0,
