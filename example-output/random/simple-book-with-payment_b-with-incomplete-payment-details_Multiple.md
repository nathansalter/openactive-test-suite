[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:35:19 GMT+0000 (Coordinated Universal Time)

# simple-book-with-payment >> b-with-incomplete-payment-details (Multiple)
...
## Missing identifier in payment property at B
...
Response status code: 200 OK. Responded in 30.81643ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/702/events/7011"
}
```
...
Response status code: 200 OK. Responded in 30.002034ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/998/events/9976"
}
```
...
Response status code: 200 OK. Responded in 29.466637ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3407"
}
```
...
Response status code: 200 OK. Responded in 29.157238ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/101/facility-use-slots/1001"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/ac2a20f9-63d2-56f0-9a36-4e41ec6c4f72

---

Response status code: 404 Not Found. Responded in 24.237469ms
```json
{
  "@context": "https://openactive.io/",
...
## Missing identifier in payment property at B >> Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F702%2Fevents%2F7011?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 26.463053ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/702",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/702#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-10-16T13:57:08+00:00",
    "endDate": "2020-10-16T15:03:08+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F998%2Fevents%2F9976?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 25.941256ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-09T00:53:18+00:00",
    "endDate": "2020-10-09T02:29:18+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F341%2Ffacility-use-slots%2F3407?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 25.500459ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/341/facility-use-slots/3407#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 9.46,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-07T22:55:19+00:00",
    "endDate": "2020-10-08T00:38:19+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F101%2Ffacility-use-slots%2F1001?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 25.092662ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/101",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/101/facility-use-slots/1001#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 5,
    "startDate": "2020-10-12T05:15:03+00:00",
    "endDate": "2020-10-12T08:48:03+00:00"
  }
}
```
### Specs
...
## Missing identifier in payment property at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 0
### Specs
...
## Missing identifier in payment property at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookablePaid' required for this test
...
## Missing identifier in payment property at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
...
## Missing identifier in payment property at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookablePaid' required for this test
...
## Missing identifier in payment property at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookablePaid' required for this test
...
## Missing identifier in payment property at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Missing identifier in payment property at B >> C1

### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ac2a20f9-63d2-56f0-9a36-4e41ec6c4f72
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 329.673587ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ac2a20f9-63d2-56f0-9a36-4e41ec6c4f72",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/702"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3,
        "startDate": "2020-10-16T13:57:08+00:00",
...
## Missing identifier in payment property at B >> C1 >> validation of C1
### Specs
* ✅ passes validation checks
...
## Missing identifier in payment property at B >> C2

### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ac2a20f9-63d2-56f0-9a36-4e41ec6c4f72
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 646.208169ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:26+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
## Missing identifier in payment property at B >> C2 >> validation of C2
### Specs
* ✅ passes validation checks
...
## Missing identifier in payment property at B >> B

### B Request
PUT https://localhost:5001/api/openbooking/orders/ac2a20f9-63d2-56f0-9a36-4e41ec6c4f72
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 1288.068422ms
```json
{
  "@context": "https://openactive.io/",
...
* ✅ should return a(n) IncompletePaymentDetailsError

## Missing identifier in payment property at B >> B >> validation of B
### Specs
* ✅ passes validation checks
