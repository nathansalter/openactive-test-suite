...
⚠️ 26 passed with 0 failures, 307 warnings and 66 suggestions 
...
Response status code: 200 OK. Responded in 10.957936ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/889/events/8890"
}
```
...
Response status code: 200 OK. Responded in 10.501839ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/474/events/4733"
}
```
...
Response status code: 200 OK. Responded in 10.28004ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/153/facility-use-slots/1523"
}
```
...
Response status code: 200 OK. Responded in 9.960542ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/556/facility-use-slots/5558"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F889%2Fevents%2F8890?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 10.21064ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/889",
      "name": "Soft Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/889#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-10-10T20:06:22+00:00",
    "endDate": "2020-10-10T21:52:22+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F474%2Fevents%2F4733?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.367451ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/474",
      "name": "Steel Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/474#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-10-11T01:58:16+00:00",
    "endDate": "2020-10-11T06:15:16+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F153%2Ffacility-use-slots%2F1523?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.034653ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/153",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/153/facility-use-slots/1523#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
    ...
    "remainingUses": 0,
    "startDate": "2020-10-13T16:40:36+00:00",
    "endDate": "2020-10-13T17:24:36+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F556%2Ffacility-use-slots%2F5558?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 7.713755ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/556/facility-use-slots/5558#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 8,
    "startDate": "2020-10-13T11:28:39+00:00",
    "endDate": "2020-10-13T17:05:39+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4d3672cd-2e71-5e79-bb31-1dbf05902adf
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 409 Conflict. Responded in 351.651351ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4d3672cd-2e71-5e79-bb31-1dbf05902adf",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/889"
        },
        "maximumAttendeeCapacity": 0,
        "remainingAttendeeCapacity": 0,
        "startDate": "2020-10-10T20:06:22+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4d3672cd-2e71-5e79-bb31-1dbf05902adf
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 409 Conflict. Responded in 668.14363ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:15+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
 ...
 * ⚠️ $.orderedItem[1].error[0].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[1].error[0].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[1].error[1].description: Recommended property `description` is missing from `OpportunityHasInsufficientCapacityError`.
 * ⚠️ $.orderedItem[1].error[1].instance: Recommended property `instance` is missing from `OpportunityHasInsufficientCapacityError`.
 * ⚠️ $.orderedItem[1].orderedItem.eventStatus: Recommended property `eventStatus` is missing from `ScheduledSession`.
 * ⚠️ $.orderedItem[1].orderedItem.superEvent.ageRange: Recommended property `ageRange` is missing from `SessionSeries`.
 * ⚠️ $.orderedItem[1].orderedItem.superEvent.genderRestriction: Recommended property `genderRestriction` is missing from `SessionSeries`.
 * ⚠️ $.orderedItem[1].orderedItem.superEvent.eventStatus: Recommended property `eventStatus` is missing from `SessionSeries`.
 ...
 * ⚠️ $.orderedItem[3].error[0].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[3].error[0].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[3].error[1].description: Recommended property `description` is missing from `OpportunityHasInsufficientCapacityError`.
 * ⚠️ $.orderedItem[3].error[1].instance: Recommended property `instance` is missing from `OpportunityHasInsufficientCapacityError`.
 * ⚠️ $.orderedItem[3].orderedItem.duration: Recommended property `duration` is missing from `Slot`.
 * ⚠️ $.orderedItem[3].orderedItem.facilityUse.description: Recommended property `description` is missing from `FacilityUse`.
 * ⚠️ $.orderedItem[3].orderedItem.facilityUse.image: Recommended property `image` is missing from `FacilityUse`.
 * ⚠️ $.orderedItem[3].orderedItem.facilityUse.hoursAvailable: Recommended property `hoursAvailable` is missing from `FacilityUse`.
 ...
 * ⚠️ $.orderedItem[4].error[0].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[4].error[0].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[4].error[1].description: Recommended property `description` is missing from `OpportunityHasInsufficientCapacityError`.
 * ⚠️ $.orderedItem[4].error[1].instance: Recommended property `instance` is missing from `OpportunityHasInsufficientCapacityError`.
 * ⚠️ $.orderedItem[4].orderedItem.duration: Recommended property `duration` is missing from `Slot`.
 * ⚠️ $.orderedItem[4].orderedItem.facilityUse.description: Recommended property `description` is missing from `FacilityUse`.
 * ⚠️ $.orderedItem[4].orderedItem.facilityUse.image: Recommended property `image` is missing from `FacilityUse`.
 * ⚠️ $.orderedItem[4].orderedItem.facilityUse.hoursAvailable: Recommended property `hoursAvailable` is missing from `FacilityUse`.
