...
Response status code: 200 OK. Responded in 21.302085ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/255/events/2541"
}
```
...
Response status code: 200 OK. Responded in 21.392685ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/99/events/982"
}
```
...
Response status code: 200 OK. Responded in 21.491185ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/564/facility-use-slots/5636"
}
```
...
Response status code: 200 OK. Responded in 22.116281ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/193/facility-use-slots/1921"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F255%2Fevents%2F2541?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 25.307464ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-09T04:09:23+00:00",
    "endDate": "2020-10-09T05:36:23+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F99%2Fevents%2F982?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 26.283158ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-08T06:11:32+00:00",
    "endDate": "2020-10-08T11:31:32+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F564%2Ffacility-use-slots%2F5636?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 25.702162ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/564",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/564/facility-use-slots/5636#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 6,
    "startDate": "2020-10-16T06:19:33+00:00",
    "endDate": "2020-10-16T10:09:33+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F193%2Ffacility-use-slots%2F1921?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 25.357063ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/193/facility-use-slots/1921#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 6,
    "startDate": "2020-10-11T10:44:47+00:00",
    "endDate": "2020-10-11T12:45:47+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bc32ca8e-b263-5b0e-9e29-931297b55d7f
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 622.29557ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bc32ca8e-b263-5b0e-9e29-931297b55d7f",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bc32ca8e-b263-5b0e-9e29-931297b55d7f
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 754.845289ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:31+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bc32ca8e-b263-5b0e-9e29-931297b55d7f
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 798.688589ms
```json
{
  "@context": "https://openactive.io/",
