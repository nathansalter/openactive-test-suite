[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:35:34 GMT+0000 (Coordinated Universal Time)

# named-leasing >> lease-response (Multiple)
...
Response status code: 200 OK. Responded in 21.31829ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/488/events/4874"
}
```
...
Response status code: 200 OK. Responded in 21.543589ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/754/events/7536"
}
```
...
Response status code: 200 OK. Responded in 25.506869ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/541/facility-use-slots/5409"
}
```
...
Response status code: 200 OK. Responded in 32.310135ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6149"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F488%2Fevents%2F4874?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 31.937736ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-13T21:31:02+00:00",
    "endDate": "2020-10-13T23:27:02+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F754%2Fevents%2F7536?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 31.577238ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/754",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/754#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 8.07,
    ...
    "startDate": "2020-10-16T18:12:05+00:00",
    "endDate": "2020-10-16T21:56:05+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F541%2Ffacility-use-slots%2F5409?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 31.31434ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/541",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/541/facility-use-slots/5409#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 1.4,
    ...
    "remainingUses": 4,
    "startDate": "2020-10-10T22:54:52+00:00",
    "endDate": "2020-10-11T01:06:52+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F615%2Ffacility-use-slots%2F6149?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 31.022141ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/615/facility-use-slots/6149#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 12.88,
    ...
    "remainingUses": 3,
    "startDate": "2020-10-12T05:46:12+00:00",
    "endDate": "2020-10-12T09:04:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/28bb641b-d2e8-5596-96a5-c845d002b1dd
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 392.275101ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/28bb641b-d2e8-5596-96a5-c845d002b1dd",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/754"
        },
        "maximumAttendeeCapacity": 38,
        "remainingAttendeeCapacity": 38,
        "startDate": "2020-10-16T18:12:05+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/541"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2020-10-10T22:54:52+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/28bb641b-d2e8-5596-96a5-c845d002b1dd
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 594.546887ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:40+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
