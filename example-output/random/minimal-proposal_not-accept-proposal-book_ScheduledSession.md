[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:35:16 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 32.368615ms
```json
{
...
Response status code: 200 OK. Responded in 12.914826ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-16T02:08:59+00:00",
    "endDate": "2020-10-16T07:41:59+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b97009bb-5d76-5800-8a1e-faee4e6ebde3
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 275.835422ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b97009bb-5d76-5800-8a1e-faee4e6ebde3",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b97009bb-5d76-5800-8a1e-faee4e6ebde3
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 743.747869ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:18+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### get-order Request
GET http://localhost:3000/get-order/b97009bb-5d76-5800-8a1e-faee4e6ebde3
**Response still pending**

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b97009bb-5d76-5800-8a1e-faee4e6ebde3
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 200 OK. Responded in 214.383287ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b97009bb-5d76-5800-8a1e-faee4e6ebde3",
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b97009bb-5d76-5800-8a1e-faee4e6ebde3/versions/6db220d6-164b-4b39-a8fd-a7edc76637ad",
  "payment": {
    "@type": "Payment",
    "identifier": "1234567890npduy2f",
    "name": "AcmeBroker Points",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b97009bb-5d76-5800-8a1e-faee4e6ebde3
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 500 Internal Server Error. Responded in 192.81491ms
```json
{
  "@context": "https://openactive.io/",
...
get-order - GET http://localhost:3000/get-order/b97009bb-5d76-5800-8a1e-faee4e6ebde3
