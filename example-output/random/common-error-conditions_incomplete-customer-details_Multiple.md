...
⚠️ 29 passed with 0 failures, 483 warnings and 114 suggestions 
...
Response status code: 200 OK. Responded in 26.282149ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/507/events/5061"
}
```
...
Response status code: 200 OK. Responded in 25.512053ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/215/events/2145"
}
```
...
Response status code: 200 OK. Responded in 24.958857ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/520/facility-use-slots/5199"
}
```
...
Response status code: 200 OK. Responded in 24.30486ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/705/facility-use-slots/7048"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F507%2Fevents%2F5061?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 29.260932ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-16T14:26:51+00:00",
    "endDate": "2020-10-16T16:39:51+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F215%2Fevents%2F2145?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 24.731258ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/215",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/215#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 10.25,
    ...
    "startDate": "2020-10-11T15:03:09+00:00",
    "endDate": "2020-10-11T19:59:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F520%2Ffacility-use-slots%2F5199?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 24.037962ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/520/facility-use-slots/5199#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 5,
    "startDate": "2020-10-08T15:44:13+00:00",
    "endDate": "2020-10-08T19:12:13+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F705%2Ffacility-use-slots%2F7048?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 23.445065ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/705/facility-use-slots/7048#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 16.1,
    ...
    "remainingUses": 7,
    "startDate": "2020-10-12T09:22:46+00:00",
    "endDate": "2020-10-12T10:14:46+00:00"
  }
}
```
### Specs
...
## Incomplete Customer Details at C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Customer Details at C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Customer Details at C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/43afd07f-519b-5029-a709-aa9a5c48400c
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 951.165479ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/43afd07f-519b-5029-a709-aa9a5c48400c",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/43afd07f-519b-5029-a709-aa9a5c48400c
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 400 Bad Request. Responded in 190.292424ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 43.835352ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/961/events/9606"
}
```
...
Response status code: 200 OK. Responded in 49.266222ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/948/events/9471"
}
```
...
Response status code: 200 OK. Responded in 57.993572ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4752"
}
```
...
Response status code: 200 OK. Responded in 87.023208ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/801/facility-use-slots/8001"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F961%2Fevents%2F9606?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 6.463563ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-10T22:49:58+00:00",
    "endDate": "2020-10-11T02:45:58+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F948%2Fevents%2F9471?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 7.192659ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/948",
      "name": "Frozen Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/948#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 7.71,
    ...
    "startDate": "2020-10-10T16:47:05+00:00",
    "endDate": "2020-10-10T18:21:05+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F476%2Ffacility-use-slots%2F4752?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 9.306948ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4752#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 6,
    "startDate": "2020-10-17T19:47:31+00:00",
    "endDate": "2020-10-18T01:29:31+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F801%2Ffacility-use-slots%2F8001?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.063404ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/801/facility-use-slots/8001#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-15T19:09:39+00:00",
    "endDate": "2020-10-15T22:53:39+00:00"
  }
}
```
### Specs
...
## Incomplete Customer Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Customer Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Customer Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/422bb653-cedb-5411-ae49-5d113141fb62
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 871.969697ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/422bb653-cedb-5411-ae49-5d113141fb62",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/948"
        },
        "maximumAttendeeCapacity": 49,
        "remainingAttendeeCapacity": 49,
        "startDate": "2020-10-10T16:47:05+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/422bb653-cedb-5411-ae49-5d113141fb62
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 596.838768ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:22+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/422bb653-cedb-5411-ae49-5d113141fb62
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 145.472292ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
