...
⚠️ 19 passed with 0 failures, 385 warnings and 84 suggestions 
...
Response status code: 200 OK. Responded in 19.226693ms
```json
{
...
Response status code: 200 OK. Responded in 18.614096ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 18.291598ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3607"
}
```
...
Response status code: 200 OK. Responded in 17.807401ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/859/facility-use-slots/8581"
}
```
...
Response status code: 200 OK. Responded in 45.557246ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-17T19:07:40+00:00",
    "endDate": "2020-10-17T22:45:40+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 45.199849ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-09T09:13:20+00:00",
    "endDate": "2020-10-09T10:09:20+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F361%2Ffacility-use-slots%2F3607?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 44.673252ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3607#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "openBookingFlowRequirement": [
    ...
    "remainingUses": 6,
    "startDate": "2020-10-13T07:46:24+00:00",
    "endDate": "2020-10-13T13:32:24+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F859%2Ffacility-use-slots%2F8581?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 44.280454ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/859",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/859/facility-use-slots/8581#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 17.94,
    ...
    "remainingUses": 6,
    "startDate": "2020-10-15T17:27:38+00:00",
    "endDate": "2020-10-15T21:57:38+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/37517466-9ca6-5989-a852-7eb8dd739cb4
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 847.938808ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/37517466-9ca6-5989-a852-7eb8dd739cb4",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/859"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2020-10-15T17:27:38+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/37517466-9ca6-5989-a852-7eb8dd739cb4
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 689.321211ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:24+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### get-order Request
GET http://localhost:3000/get-order/37517466-9ca6-5989-a852-7eb8dd739cb4
**Response still pending**

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/37517466-9ca6-5989-a852-7eb8dd739cb4
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
...
Response status code: 200 OK. Responded in 704.723454ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/37517466-9ca6-5989-a852-7eb8dd739cb4",
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/37517466-9ca6-5989-a852-7eb8dd739cb4/versions/b4462c4e-7c2c-431a-a08d-ff3d7bb6dac6",
  "payment": {
    "@type": "Payment",
    "identifier": "1234567890npduy2f",
    "name": "AcmeBroker Points",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/37517466-9ca6-5989-a852-7eb8dd739cb4
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 500 Internal Server Error. Responded in 316.144982ms
```json
{
  "@context": "https://openactive.io/",
...
get-order - GET http://localhost:3000/get-order/37517466-9ca6-5989-a852-7eb8dd739cb4
