[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:35:23 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 3.54178ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/366/facility-use-slots/3656"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/773d6f7f-04c8-59ef-b3ec-a169a3f55f66

---

Response status code: 404 Not Found. Responded in 36.523402ms
```json
{
  "@context": "https://openactive.io/",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F366%2Ffacility-use-slots%2F3656?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 12.90263ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/366",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/366/facility-use-slots/3656#/offers/0",
        "availableChannel": [
    ...
    "remainingUses": 8,
    "startDate": "2020-10-11T21:29:42+00:00",
    "endDate": "2020-10-11T22:42:42+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/773d6f7f-04c8-59ef-b3ec-a169a3f55f66
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 405.253787ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/773d6f7f-04c8-59ef-b3ec-a169a3f55f66",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/773d6f7f-04c8-59ef-b3ec-a169a3f55f66
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 511.819616ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/773d6f7f-04c8-59ef-b3ec-a169a3f55f66
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 933.796047ms
```json
{
  "@context": "https://openactive.io/",
