...
⚠️ 35 passed with 0 failures, 665 warnings and 150 suggestions 
...
Response status code: 200 OK. Responded in 25.330942ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/535/events/5348"
}
```
...
Response status code: 200 OK. Responded in 24.067751ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/767/events/7670"
}
```
...
Response status code: 200 OK. Responded in 15.552804ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
Response status code: 200 OK. Responded in 15.226105ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/311/facility-use-slots/3101"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F535%2Fevents%2F5348?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 14.648009ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-13T11:54:56+00:00",
    "endDate": "2020-10-13T17:20:56+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F767%2Fevents%2F7670?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 14.342511ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/767",
      "name": "Steel Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/767#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-10-11T20:49:01+00:00",
    "endDate": "2020-10-12T00:49:01+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 14.031313ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "remainingUses": 2,
    "startDate": "2020-10-16T17:23:16+00:00",
    "endDate": "2020-10-16T21:18:16+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F311%2Ffacility-use-slots%2F3101?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.746914ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/311",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/311/facility-use-slots/3101#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 4,
    "startDate": "2020-10-09T21:14:40+00:00",
    "endDate": "2020-10-10T02:46:40+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9017980c-7ae4-5abf-8886-dff4ecc248d5
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 694.642414ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9017980c-7ae4-5abf-8886-dff4ecc248d5",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9017980c-7ae4-5abf-8886-dff4ecc248d5
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 758.13666ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 13.05982ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/345/events/3447"
}
```
...
Response status code: 200 OK. Responded in 12.472624ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/676/events/6752"
}
```
...
Response status code: 200 OK. Responded in 12.120126ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/785/facility-use-slots/7843"
}
```
...
Response status code: 200 OK. Responded in 11.713929ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4207"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F345%2Fevents%2F3447?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 40.253255ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-13T09:16:18+00:00",
    "endDate": "2020-10-13T13:20:18+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F676%2Fevents%2F6752?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 24.524351ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-15T15:57:29+00:00",
    "endDate": "2020-10-15T17:13:29+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F785%2Ffacility-use-slots%2F7843?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 24.455751ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/785",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/785/facility-use-slots/7843#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 2.11,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-14T16:07:41+00:00",
    "endDate": "2020-10-14T21:55:41+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F421%2Ffacility-use-slots%2F4207?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 16.241001ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4207#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 8,
    "startDate": "2020-10-11T13:27:07+00:00",
    "endDate": "2020-10-11T17:32:07+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 380.502598ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/785"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2020-10-14T16:07:41+00:00",
...
Response status code: 200 OK. Responded in 494.378228ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:09+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9017980c-7ae4-5abf-8886-dff4ecc248d5
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 562.566541ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9017980c-7ae4-5abf-8886-dff4ecc248d5",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9017980c-7ae4-5abf-8886-dff4ecc248d5#/orderedItems/97",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/345#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9017980c-7ae4-5abf-8886-dff4ecc248d5#/orderedItems/98",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/345#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9017980c-7ae4-5abf-8886-dff4ecc248d5#/orderedItems/99",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/676#/offers/0",
        "price": 1.61,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9017980c-7ae4-5abf-8886-dff4ecc248d5#/orderedItems/100",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/785/facility-use-slots/7843#/offers/0",
        "price": 2.11,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9017980c-7ae4-5abf-8886-dff4ecc248d5#/orderedItems/101",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/785/facility-use-slots/7843#/offers/0",
        "price": 2.11,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9017980c-7ae4-5abf-8886-dff4ecc248d5#/orderedItems/102",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4207#/offers/0",
        "price": 0,
