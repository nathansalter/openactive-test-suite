...
⚠️ 40 passed with 0 failures, 584 warnings and 132 suggestions 
...
Response status code: 200 OK. Responded in 14.325702ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/496/events/4956"
}
```
...
Response status code: 200 OK. Responded in 13.750106ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/163/events/1624"
}
```
...
Response status code: 200 OK. Responded in 15.898791ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/372/facility-use-slots/3720"
}
```
...
Response status code: 200 OK. Responded in 16.266589ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/263/facility-use-slots/2624"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F496%2Fevents%2F4956?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.906019ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-12T01:48:03+00:00",
    "endDate": "2020-10-12T07:34:03+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F163%2Fevents%2F1624?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.61282ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/163",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/163#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 11.82,
    ...
    "startDate": "2020-10-16T20:28:55+00:00",
    "endDate": "2020-10-17T00:03:55+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F372%2Ffacility-use-slots%2F3720?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.182224ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/372",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/372/facility-use-slots/3720#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 6,
    "startDate": "2020-10-08T11:23:35+00:00",
    "endDate": "2020-10-08T13:43:35+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F263%2Ffacility-use-slots%2F2624?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 10.637927ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/263",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/263/facility-use-slots/2624#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 6,
    "startDate": "2020-10-16T02:51:38+00:00",
    "endDate": "2020-10-16T04:58:38+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/43d19df0-2e96-5e24-883c-c39291f80e75
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 695.421174ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/43d19df0-2e96-5e24-883c-c39291f80e75",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/163"
        },
        "maximumAttendeeCapacity": 7,
        "remainingAttendeeCapacity": 7,
        "startDate": "2020-10-16T20:28:55+00:00",
...
Response status code: 200 OK. Responded in 28.707807ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/699/events/6987"
}
```
...
Response status code: 200 OK. Responded in 28.230111ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/99/events/984"
}
```
...
Response status code: 200 OK. Responded in 27.921413ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/458/facility-use-slots/4578"
}
```
...
Response status code: 200 OK. Responded in 22.856746ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/837/facility-use-slots/8367"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F699%2Fevents%2F6987?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 21.350857ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/699",
      "name": "Rubber Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/699#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-10-11T04:20:33+00:00",
    "endDate": "2020-10-11T08:35:33+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F99%2Fevents%2F984?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 20.93906ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-09T08:59:31+00:00",
    "endDate": "2020-10-09T09:59:31+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F458%2Ffacility-use-slots%2F4578?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 20.422763ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/458",
      "name": "Soft Running Hall",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/458/facility-use-slots/4578#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-13T00:48:41+00:00",
    "endDate": "2020-10-13T01:31:41+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F837%2Ffacility-use-slots%2F8367?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 20.132165ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/837",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/837/facility-use-slots/8367#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 1.98,
    ...
    "remainingUses": 8,
    "startDate": "2020-10-12T00:08:54+00:00",
    "endDate": "2020-10-12T01:54:54+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/43d19df0-2e96-5e24-883c-c39291f80e75
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 464.317903ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/837"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2020-10-12T00:08:54+00:00",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/43d19df0-2e96-5e24-883c-c39291f80e75
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 590.672793ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/43d19df0-2e96-5e24-883c-c39291f80e75",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/43d19df0-2e96-5e24-883c-c39291f80e75#/orderedItems/35",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/699#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/43d19df0-2e96-5e24-883c-c39291f80e75#/orderedItems/36",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/699#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/43d19df0-2e96-5e24-883c-c39291f80e75#/orderedItems/37",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/99#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/43d19df0-2e96-5e24-883c-c39291f80e75#/orderedItems/38",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/458/facility-use-slots/4578#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/43d19df0-2e96-5e24-883c-c39291f80e75#/orderedItems/39",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/458/facility-use-slots/4578#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/43d19df0-2e96-5e24-883c-c39291f80e75#/orderedItems/40",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/837/facility-use-slots/8367#/offers/0",
        "price": 1.98,
