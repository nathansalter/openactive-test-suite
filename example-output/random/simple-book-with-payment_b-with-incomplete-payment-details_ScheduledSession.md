...
Response status code: 200 OK. Responded in 37.13639ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/148/events/1480"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/256ab486-3a3e-506b-8fc6-257daeec12ac

---

Response status code: 404 Not Found. Responded in 223.255052ms
```json
{
  "@context": "https://openactive.io/",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F148%2Fevents%2F1480?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 12.594129ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-08T16:37:30+00:00",
    "endDate": "2020-10-08T19:07:30+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/256ab486-3a3e-506b-8fc6-257daeec12ac
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 343.158859ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/256ab486-3a3e-506b-8fc6-257daeec12ac",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/256ab486-3a3e-506b-8fc6-257daeec12ac
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 340.795884ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:20+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/256ab486-3a3e-506b-8fc6-257daeec12ac
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 779.261032ms
```json
{
  "@context": "https://openactive.io/",
