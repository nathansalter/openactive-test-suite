[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:35:33 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 26.447464ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/272/events/2720"
}
```
...
Response status code: 200 OK. Responded in 25.998667ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/362/events/3611"
}
```
...
Response status code: 200 OK. Responded in 25.698068ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/323/facility-use-slots/3225"
}
```
...
Response status code: 200 OK. Responded in 25.24487ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/203/facility-use-slots/2025"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F272%2Fevents%2F2720?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 27.031462ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-08T06:36:15+00:00",
    "endDate": "2020-10-08T08:34:15+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F362%2Fevents%2F3611?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 18.451005ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-11T07:44:10+00:00",
    "endDate": "2020-10-11T10:36:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F323%2Ffacility-use-slots%2F3225?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.765209ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/323",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/323/facility-use-slots/3225#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-10T05:00:52+00:00",
    "endDate": "2020-10-10T06:32:52+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F203%2Ffacility-use-slots%2F2025?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.046713ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/203",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/203/facility-use-slots/2025#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-12T11:22:12+00:00",
    "endDate": "2020-10-12T16:39:12+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/147a90b5-fb0e-5224-ab7c-09b7cc71b818
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 640.959136ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/147a90b5-fb0e-5224-ab7c-09b7cc71b818",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/323"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2020-10-10T05:00:52+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/147a90b5-fb0e-5224-ab7c-09b7cc71b818
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 1332.319262ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:41+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/147a90b5-fb0e-5224-ab7c-09b7cc71b818
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 200 OK. Responded in 715.754607ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/147a90b5-fb0e-5224-ab7c-09b7cc71b818",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/147a90b5-fb0e-5224-ab7c-09b7cc71b818#/orderedItems/204",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/272#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/147a90b5-fb0e-5224-ab7c-09b7cc71b818#/orderedItems/205",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/272#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/147a90b5-fb0e-5224-ab7c-09b7cc71b818#/orderedItems/206",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/362#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/147a90b5-fb0e-5224-ab7c-09b7cc71b818#/orderedItems/207",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/323/facility-use-slots/3225#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/147a90b5-fb0e-5224-ab7c-09b7cc71b818#/orderedItems/208",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/323/facility-use-slots/3225#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/147a90b5-fb0e-5224-ab7c-09b7cc71b818#/orderedItems/209",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/203/facility-use-slots/2025#/offers/0",
        "price": 0,
