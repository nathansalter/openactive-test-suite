...
⚠️ 26 passed with 0 failures, 283 warnings and 66 suggestions 
...
Response status code: 200 OK. Responded in 25.488265ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/702/events/7020"
}
```
...
Response status code: 200 OK. Responded in 25.583865ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 31.237635ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/774/facility-use-slots/7734"
}
```
...
Response status code: 200 OK. Responded in 30.739038ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/91/facility-use-slots/907"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F702%2Fevents%2F7020?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 39.208693ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-12T01:28:20+00:00",
    "endDate": "2020-10-12T02:48:20+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 38.648496ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-15T21:54:28+00:00",
    "endDate": "2020-10-16T03:33:28+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F774%2Ffacility-use-slots%2F7734?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 38.360297ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/774",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/774/facility-use-slots/7734#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 5,
    "startDate": "2020-10-08T17:52:25+00:00",
    "endDate": "2020-10-08T19:58:25+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F91%2Ffacility-use-slots%2F907?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 41.082183ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/91/facility-use-slots/907#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 12.98,
    ...
    "remainingUses": 8,
    "startDate": "2020-10-09T06:09:15+00:00",
    "endDate": "2020-10-09T11:12:15+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/59e75bc6-eb73-5c67-837e-c64d2be73a48
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 813.066052ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/59e75bc6-eb73-5c67-837e-c64d2be73a48",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/774"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2020-10-08T17:52:25+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/59e75bc6-eb73-5c67-837e-c64d2be73a48
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 789.078004ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:35+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
