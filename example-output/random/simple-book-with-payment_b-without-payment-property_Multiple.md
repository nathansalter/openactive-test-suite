...
Response status code: 200 OK. Responded in 13.808525ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/271/events/2707"
}
```
...
Response status code: 200 OK. Responded in 13.248328ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/931/events/9302"
}
```
...
Response status code: 200 OK. Responded in 12.756931ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/89/facility-use-slots/886"
}
```
...
Response status code: 200 OK. Responded in 12.304134ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/62/facility-use-slots/612"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/a8bb89ee-f376-5102-8072-a2ce81000fc8

---

Response status code: 404 Not Found. Responded in 20.73199ms
```json
{
  "@context": "https://openactive.io/",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F271%2Fevents%2F2707?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.171907ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-12T00:41:10+00:00",
    "endDate": "2020-10-12T03:17:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F931%2Fevents%2F9302?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 16.783709ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-16T07:58:06+00:00",
    "endDate": "2020-10-16T10:00:06+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F89%2Ffacility-use-slots%2F886?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 20.261191ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/89/facility-use-slots/886#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 10.04,
    ...
    "remainingUses": 4,
    "startDate": "2020-10-12T04:35:03+00:00",
    "endDate": "2020-10-12T10:11:03+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F62%2Ffacility-use-slots%2F612?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 19.936792ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/62/facility-use-slots/612#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 11,
    ...
    "remainingUses": 6,
    "startDate": "2020-10-14T19:37:08+00:00",
    "endDate": "2020-10-14T22:52:08+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a8bb89ee-f376-5102-8072-a2ce81000fc8
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 483.860507ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a8bb89ee-f376-5102-8072-a2ce81000fc8",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a8bb89ee-f376-5102-8072-a2ce81000fc8
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 656.497005ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a8bb89ee-f376-5102-8072-a2ce81000fc8
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 696.131214ms
```json
{
  "@context": "https://openactive.io/",
