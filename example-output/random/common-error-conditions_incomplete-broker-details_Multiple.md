[< Return to Summary](summary.md) | File Generated: Wed Oct 07 2020 20:34:59 GMT+0000 (Coordinated Universal Time)
...
⚠️ 42 passed with 0 failures, 598 warnings and 144 suggestions 
...
Response status code: 200 OK. Responded in 10.014638ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/756/events/7556"
}
```
...
Response status code: 200 OK. Responded in 10.244636ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/496/events/4958"
}
```
...
Response status code: 200 OK. Responded in 9.899138ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/174/facility-use-slots/1731"
}
```
...
Response status code: 200 OK. Responded in 9.64864ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/52/facility-use-slots/514"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F756%2Fevents%2F7556?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 12.007325ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/756",
      "name": "Soft Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/756#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-10-12T14:46:42+00:00",
    "endDate": "2020-10-12T18:01:42+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F496%2Fevents%2F4958?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.678827ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/496",
      "name": "Granite Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/496#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-10-08T07:21:48+00:00",
    "endDate": "2020-10-08T10:34:48+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F174%2Ffacility-use-slots%2F1731?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.373829ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/174",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/174/facility-use-slots/1731#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 8,
    "startDate": "2020-10-09T20:46:00+00:00",
    "endDate": "2020-10-10T01:23:00+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F52%2Ffacility-use-slots%2F514?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.14453ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/52",
      "name": "Plastic Running Hall",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/52/facility-use-slots/514#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 8,
    "startDate": "2020-10-11T00:23:46+00:00",
    "endDate": "2020-10-11T01:22:46+00:00"
  }
}
```
### Specs
...
## Incomplete Broker Details at C1 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Broker Details at C1 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Broker Details at C1 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f0497ed3-cc89-5798-a542-5ed4d8912d25
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 400 Bad Request. Responded in 26.760833ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 29.185619ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/931/events/9303"
}
```
...
Response status code: 200 OK. Responded in 28.777521ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/611/events/6110"
}
```
...
Response status code: 200 OK. Responded in 28.537023ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
Response status code: 200 OK. Responded in 28.588822ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/490/facility-use-slots/4899"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F931%2Fevents%2F9303?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 41.262643ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/931",
      "name": "Wooden Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/931#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 3.66,
    ...
    "startDate": "2020-10-17T07:16:27+00:00",
    "endDate": "2020-10-17T08:48:27+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F611%2Fevents%2F6110?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 40.720747ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/611",
      "name": "Steel Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/611#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-10-14T10:50:36+00:00",
    "endDate": "2020-10-14T14:35:36+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 40.432748ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "remainingUses": 8,
    "startDate": "2020-10-14T18:03:22+00:00",
    "endDate": "2020-10-14T23:18:22+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F490%2Ffacility-use-slots%2F4899?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 39.898753ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/490",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/490/facility-use-slots/4899#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-11T01:37:05+00:00",
    "endDate": "2020-10-11T05:06:05+00:00"
  }
}
```
### Specs
...
## Incomplete Broker Details at C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Broker Details at C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Broker Details at C2 >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8616ae3b-dc27-5918-b0df-48d2d2eb2333
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 661.201124ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8616ae3b-dc27-5918-b0df-48d2d2eb2333",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/931"
        },
        "maximumAttendeeCapacity": 19,
        "remainingAttendeeCapacity": 19,
        "startDate": "2020-10-17T07:16:27+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/490"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2020-10-11T01:37:05+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8616ae3b-dc27-5918-b0df-48d2d2eb2333
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 400 Bad Request. Responded in 11.543029ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
Response status code: 200 OK. Responded in 13.576317ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/424/events/4234"
}
```
...
Response status code: 200 OK. Responded in 13.225919ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/906/events/9054"
}
```
...
Response status code: 200 OK. Responded in 12.841621ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/5/facility-use-slots/45"
}
```
...
Response status code: 200 OK. Responded in 11.315631ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/346/facility-use-slots/3458"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F424%2Fevents%2F4234?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 15.142008ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/424",
      "name": "Fresh Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/424#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 3.37,
    ...
    "maximumAttendeeCapacity": 3,
    "remainingAttendeeCapacity": 3,
    "startDate": "2020-10-09T08:24:47+00:00",
    "endDate": "2020-10-09T11:39:47+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F906%2Fevents%2F9054?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 14.829909ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-10-14T09:25:46+00:00",
    "endDate": "2020-10-14T12:06:46+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F5%2Ffacility-use-slots%2F45?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 14.510211ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/5/facility-use-slots/45#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 11.37,
    ...
    "remainingUses": 2,
    "startDate": "2020-10-10T11:05:52+00:00",
    "endDate": "2020-10-10T16:22:52+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F346%2Ffacility-use-slots%2F3458?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 14.337212ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/346",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/346/facility-use-slots/3458#/offers/0",
        "availableChannel": [
          "https://openactive.io/OpenBookingPrepayment"
        ],
        "price": 0,
    ...
    "remainingUses": 3,
    "startDate": "2020-10-08T21:57:08+00:00",
    "endDate": "2020-10-09T01:58:08+00:00"
  }
}
```
### Specs
...
## Incomplete Broker Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Broker Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Incomplete Broker Details at B >> Get Opportunity Feed Items >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/229c3bd1-4196-57b0-9f0c-17cb755313dd
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 515.937558ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/229c3bd1-4196-57b0-9f0c-17cb755313dd",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/424"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3,
        "startDate": "2020-10-09T08:24:47+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/346"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2020-10-08T21:57:08+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/229c3bd1-4196-57b0-9f0c-17cb755313dd
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 618.357459ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-10-07T20:40:08+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/229c3bd1-4196-57b0-9f0c-17cb755313dd
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
...
Response status code: 400 Bad Request. Responded in 24.352154ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
